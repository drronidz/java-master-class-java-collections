...
public class SetChallenge {
    public static void main(String[] args) {
        ...
        *
        * You can include as many types as you want, but must support at least
        * PLANET and MOON
        *
        * For each of the types that you support, subclass the HeavenlyBody class
        * so that your program can create objects of the appropriate type.
        *
        * Although astronomers may shudder at this, ou solar systems will allow
        * two bodies to have the same name as long as they are not the same
        * type of body: so you could have a star called"BetaMinor" and
        * an asteroid also called "BetaMinor", for example.
        *
        * Hint: This is much easier to implement for the Set that it is for the Map,
        ...
        * moons. Even if you don't implement a STAR type, though, your program should not
        * prevent one being added in the future (and a STAR's satellites can be almost every
        * kind of HeavenlyBody).
        *
        * Test cases:
        ...
        *
        * 6. Two bodies with same name but different designations can be added to the same map,
